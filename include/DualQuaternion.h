...
#ifndef GADIGITALTRANSFORMATIONCERTIFICATION_DUALQUATERNION_H
#define GADIGITALTRANSFORMATIONCERTIFICATION_DUALQUATERNION_H


#include <iostream>


/*** Include classes to manipulate quaternions and dual quaternions ***/
#include <Eigen/Core>
#include <Eigen/SVD>
...
// Inverse
    template<class Scalar>
    static QuaternionScalar<Scalar> InvQ(QuaternionScalar<Scalar> a) {
        Scalar norm = a.value.x * a.value.x + a.value.y * a.value.y + a.value.z * a.value.z + a.value.w * a.value.w;
        if (norm == (Scalar) 0.0)
            return QuaternionScalar<Scalar>((Scalar) 0.0, (Scalar) 0.0, (Scalar) 0.0, (Scalar) 0.0);
    ...
    struct DualQuaternionScalar {
        QuaternionScalar<Scalar> m_real = QuaternionScalar<Scalar>((Scalar) 0.0, (Scalar) 0.0, (Scalar) 0.0,
                                                                   (Scalar) 1.0);
        QuaternionScalar<Scalar> m_dual = QuaternionScalar<Scalar>((Scalar) 0.0, (Scalar) 0.0, (Scalar) 0.0,
                                                                   (Scalar) 0.0);
        ...
        DualQuaternionScalar Inv(DualQuaternionScalar<Scalar> a) {
            ...
            DualQuaternionScalar<Scalar> q_1 = DualQuaternionScalar<Scalar>(p_1, QuaternionScalar<Scalar>(0.0, 0.0, 0.0,
                                                                                                          0.0));
            DualQuaternionScalar<Scalar> q_2 = DualQuaternionScalar<Scalar>(
                    QuaternionScalar<Scalar>(0.0, 0.0, 0.0, 1.0), p_2 * (Scalar) (-1.0));
        ...
        DualQuaternionScalar<Scalar> Identity() {
            return DualQuaternionScalar<Scalar>(QuaternionScalar<Scalar>(make_Scalar3<Scalar>(0.0f), (Scalar) 1.0),
                                                QuaternionScalar<Scalar>(make_Scalar3(0.0f), 0.0f));
        }
        ...
        DualQuaternionScalar<Scalar> Normalize() {
            ...
            QuaternionScalar<Scalar> dual_factor = (m_dual * m_real.Conjugate()) * ((Scalar) 1.0 / (norm_a *
                                                                                                    norm_a));//(m_dual * m_real.Conjugate()+ Quaternion(0.0,0.0,0.0,-1.0f*m_real.Dot(m_dual)) ) * (1.0f/(norm_a*norm_a));
...
#endif //GADIGITALTRANSFORMATIONCERTIFICATION_DUALQUATERNION_H
